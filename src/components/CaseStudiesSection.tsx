    ...
    <div className="container mx-auto px-4">
      ...
      <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {studies.map((s, i) => (
          ...
          >
            <div className="p-8">
              <h3 className="font-heading text-lg font-bold mb-6 leading-snug">{s.title}</h3>

              <div className="space-y-4 mb-6">
                <div>
                  <div className="text-xs font-semibold text-destructive tracking-wide mb-1">PROBLEM</div>
                  <p className="text-sm text-muted-foreground">{s.problem}</p>
                </div>
                <div>
                  <div className="text-xs font-semibold text-primary tracking-wide mb-1">SOLUTION</div>
              ...
              <div className="grid grid-cols-3 gap-3 pt-4 border-t border-border">
                {s.results.map((r) => (
                  <div key={r.label} className="text-center">
                    <div className="text-xl font-heading font-bold text-primary">{r.metric}</div>
